...
public partial class Presentation_StandardReports_BCTReports : System.Web.UI.Page
{
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            rdlcReportname = BAL.getBatchRDLCname(Equipment_Name);
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            //ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/DryerReport/batchreport.rdlc";
            ...
            dataset = BAL.getReportData(Equipment_Name, Batch_Number, BatchMinTime.Text, BatchMaxTime.Text, ViewName, TimeInterval);
