<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="DryerAuditReport.aspx.cs" Inherits="Presentation_StandardReports_BCTReports" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="content-header box-header with-border">
                    ...
                    <%--<div class="col-md-4">
                        <b id="B3" runat="server">Select WorkStation : </b>
                             <asp:DropDownList ID="ddl_Equipment" AutoPostBack="true" runat="server"  CssClass="form-control"  >
